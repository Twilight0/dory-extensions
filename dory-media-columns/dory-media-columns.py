...
# Andrew@webupd8.org: get EXIF support to work with Dory 3
# Julien Blanc: fix bug caused by missing Exif.Image.Software key
# mtwebster: convert for use as a dory extension
import os
import stopit
import locale
import gettext
...
from gi.repository import Dory, GObject, Gtk, GdkPixbuf, GExiv2, GLib, Gio
# for id3 support
...
class ColumnExtension(GObject.GObject, Dory.ColumnProvider, Dory.InfoProvider, Dory.NameAndDescProvider):
    def __init__(self):
        self.ids_by_handle = {}

        self.settings = Gio.Settings(schema_id="org.dory.extensions.dory-media-columns")
    ...
    def load_settings(self, settings, pspec=None, data=None):
        ...
        print("dory-media-columns: using a timeout of %.2f second(s) for file processing" % self.timeout)
    ...
    def get_columns(self):
        ...
        return (
            Dory.Column(name="DoryPython::title_column",attribute="title",label=_("Title"),description=""),
            Dory.Column(name="DoryPython::album_column",attribute="album",label=_("Album"),description=""),
            Dory.Column(name="DoryPython::artist_column",attribute="artist",label=_("Artist"),description=""),
            Dory.Column(name="DoryPython::tracknumber_column",attribute="tracknumber",label=_("Track"),description=""),
            Dory.Column(name="DoryPython::genre_column",attribute="genre",label=_("Genre"),description=""),
            Dory.Column(name="DoryPython::date_column",attribute="date",label=_("Date"),description=""),
            Dory.Column(name="DoryPython::bitrate_column",attribute="bitrate",label=_("Bitrate"),description=""),
            Dory.Column(name="DoryPython::framerate_column",attribute="framerate",label=_("Framerate"),description=""),
            Dory.Column(name="DoryPython::video_codec_column",attribute="video_codec",label=_("Video Codec"),description=""),
            Dory.Column(name="DoryPython::date_encoded_column",attribute="date_encoded",label=_("Date Encoded"),description=""),
            Dory.Column(name="DoryPython::pages_column",attribute="pages",label=_("Pages"),description=""),
            Dory.Column(name="DoryPython::samplerate_column",attribute="samplerate",label=_("Sample Rate"),description=""),
            Dory.Column(name="DoryPython::length_column",attribute="length",label=_("Length"),description=""),
            Dory.Column(name="DoryPython::composer_column", attribute="composer", label=_("Composer"), description=""),
            Dory.Column(name="DoryPython::description_column", attribute="description", label=_("Description"), description=""),
            Dory.Column(name="DoryPython::exif_datetime_original_column",attribute="exif_datetime_original",label=_("EXIF Date"),description=""),
            Dory.Column(name="DoryPython::exif_software_column",attribute="exif_software",label=_("EXIF Software"),description=""),
            Dory.Column(name="DoryPython::exif_flash_column",attribute="exif_flash",label=_("EXIF Flash"),description=""),
            Dory.Column(name="DoryPython::exif_pixeldimensions_column",attribute="exif_pixeldimensions",label=_("EXIF Image Size"),description=""),
            Dory.Column(name="DoryPython::exif_rating",attribute="exif_rating",label=_("EXIF Rating"),description=""),
            Dory.Column(name="DoryPython::pixeldimensions_column",attribute="pixeldimensions",label=_("Image Size"),description=""),
        )
    ...
    def update_file_info_full(self, provider, handle, closure, file):
        if file.get_uri_scheme() not in ('file', 'recent', 'favorites'):
            return Dory.OperationResult.COMPLETE
    ...
    def update_cb(self, provider, handle, closure, file):
        ...
        if uri.startswith("file"):
            try:
                ...
                print("dory-media-columns failed to process '%s' within a reasonable amount of time" % (gfile.get_uri(), e))
        ...
        # dory (https://github.com/linuxmint/dory/blob/master/libdory-private/dory-file.c#L6811-L6814)
        ...
        Dory.info_provider_update_complete_invoke(closure, provider, handle, Dory.OperationResult.COMPLETE)
    ...
    def get_name_and_desc(self):
        ...
        return [(f"dory-media-columns:::{description}:::dory-media-columns-prefs")]
