...
class EmblemPropertyPage(GObject.GObject, Dory.PropertyPageProvider, Dory.NameAndDescProvider):
    ...
    def get_property_pages(self, files):
        ...
        return [Dory.PropertyPage(name="DoryPython::emblem", label=self.property_label, page=self.mainWindow),]
