 ...
 *
 * dropbox.c
 * Dory module registering functions for the Dropbox extension.
 *
...
dory_module_initialize (GTypeModule *module) {
  ...
  dory_dropbox_register_type (module);
  type_list[0] = DORY_TYPE_DROPBOX;

  dropbox_use_dory_submenu_workaround
    = (DORY_VERSION_MAJOR < 2 ||
       (DORY_VERSION_MAJOR == 2 && DORY_VERSION_MINOR <= 22));
