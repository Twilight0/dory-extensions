...
from gi.repository import Dory
...
# Globals
APP_NAME = "dory-pastebin"
LOGGING = 1
MAINTAINER_MODE = True

gettext.install("dory-extensions")
...
Notify.init("Dory pastebin extension")
...
class PastebinitExtension(GObject.GObject, Dory.MenuProvider, Dory.NameAndDescProvider):
    BASE_KEY = "apps.dory-pastebin"
    def __init__(self):
        log ("Initializing dory-pastebin extension...")
    ...
    def get_file_items(self, window, files):
        ...
        #Called when the user selects a file in Dory.
        item = Dory.MenuItem(name="DoryPython::pastebin_item",
                             label=_("Pastebin to %s") % pastebin,
                             tip=_("Send this file to %s") % pastebin)
        item.set_property('icon', "dory-pastebin")
    ...
    def get_name_and_desc(self):
        ...
        return [(f"dory-pastebin:::{description}:::dory-pastebin-configurator")]
