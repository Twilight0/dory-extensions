...
class DoryTerminalPreferencesWindow(XApp.PreferencesWindow):
    def __init__(self):
        super(DoryTerminalPreferencesWindow, self).__init__()

        self.set_icon_name("terminal")
        self.set_title(_("Dory-Terminal Preferences"))
        ...
        self.settings = Gio.Settings(schema_id="org.dory.extensions.dory-terminal")
        ...
        combo.append("Terminal follows Dory", _("Terminal follows view location"))
        # combo.append("Dory follows Terminal", _("View follows terminal location"))
        # combo.append("Dory and Terminal Synchronized", _("Keep locations synchronized"))
...
if __name__ == "__main__":
    ...
    window = DoryTerminalPreferencesWindow()
