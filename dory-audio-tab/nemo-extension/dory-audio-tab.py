...
# change log:
# RavetcoFX: Forked from dory-media-columns and dory-emblems

from urllib import parse
import locale, gettext, os
import mutagen

from gi.repository import GObject, Gio, Gtk, Dory
# for id3 support
...
class AudioPropertyPage(GObject.GObject, Dory.PropertyPageProvider, Dory.NameAndDescProvider):

    def get_property_pages(self, files):
        # files: list of DoryVFSFile
        if len(files) != 1:
            return []
        ...
        self.builder.set_translation_domain('dory-extensions')
        self.builder.add_from_file("/usr/share/dory-audio-tab/dory-audio-tab.glade")
        ...
        return [
            Dory.PropertyPage(name="DoryPython::audio",
    ...
    def get_name_and_desc(self):
        ...
        return [(f"dory-audio-tab:::{description}")]
