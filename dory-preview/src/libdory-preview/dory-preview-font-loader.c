...
/**
 * dory_preview_new_ft_face_from_uri: (skip)
 *
 */
FT_Face
dory_preview_new_ft_face_from_uri (FT_Library library,
                            const gchar *uri,
                            gchar **contents,
                            GError **error)
{
...
/**
 * dory_preview_new_ft_face_from_uri_async: (skip)
 *
 */
void
dory_preview_new_ft_face_from_uri_async (FT_Library library,
                                  const gchar *uri,
                                  GAsyncReadyCallback callback,
                                  gpointer user_data)
{
...
/**
 * dory_preview_new_ft_face_from_uri_finish: (skip)
 *
 */
FT_Face
dory_preview_new_ft_face_from_uri_finish (GAsyncResult *result,
                                   gchar **contents,
                                   GError **error)
{
  FontLoadJob *job;
