...
/**
 * dory_preview_create_rounded_background:
 *
 * Returns: (transfer none): a #ClutterActor
 */
ClutterActor *
dory_preview_create_rounded_background (void)
{
  ClutterActor *retval;
...
/**
 * dory_preview_create_foreign_window:
 * @xid:
 *
 * Returns: (transfer full): a #GdkWindow
 */
GdkWindow *
dory_preview_create_foreign_window (guint xid)
{
  GdkWindow *retval;
...
/**
 * dory_preview_query_supported_document_types:
 *
 * Returns: (transfer full):
 */
gchar **
dory_preview_query_supported_document_types (void)
{
  GList *infos, *l;
  gchar **retval = NULL;
  GPtrArray *array;
