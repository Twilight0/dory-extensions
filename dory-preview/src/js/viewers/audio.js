...
const DoryPreview = imports.gi.DoryPreview;

const Gettext = imports.gettext.domain('dory-extensions');
...
AudioRenderer.prototype = {
    ...
    _createPlayer : function(file) {
        ...
        this._player = new DoryPreview.SoundPlayer({ uri: file.get_uri() });
    ...
    _onTagListChanged : function() {
        ...
        this._artFetcher = new DoryPreview.CoverArtFetcher();
    ...
    _onPlayerStateChanged : function() {
        ...
        case DoryPreview.SoundPlayerState.PLAYING:
